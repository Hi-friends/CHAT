...
class Title extends React.Component {
  ...
  render() {
    return (
      React.createElement("div", { className: "chatApp__convTitle" }, this.props.owner, "'s display"));
...
class InputMessage extends React.Component {
  ...
  render() {
    ...
    let sendButtonIcon = React.createElement("i", { className: "material-icons" }, "send");
    return (
...
class TypingIndicator extends React.Component {
  ...
  render() {
    ...
    if (countTypers > 0) {
      return (
        React.createElement("div", { className: "chatApp__convTyping" }, typersDisplay, " writing",
...
class MessageItem extends React.Component {
  render() {
    ...
    return (
      React.createElement("div", { className: "chatApp__convMessageItem " + messagePosition + " clearfix" },
...
class ChatBox extends React.Component {
  ...
  render() {
    return (
      React.createElement("div", { className: "chatApp__conv" },
      ...
      React.createElement("div", { className: "chatApp__convSendMessage clearfix" },
...
class ChatRoom extends React.Component {
  ...
  render() {
    ...
    users[0] = { name: 'yerin', avatar: 'image/profile1.png' };
    users[1] = { name: 'hyeonjin', avatar: 'image/profile2.png' };
